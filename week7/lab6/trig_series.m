...
n = [1:11];
%% DC component
half_a0 = (2/T)*(int(A,t,0,T/2)+int(-A,t,T/2,T))
%% Compute harmonics
ai = (2/T)*(int(A*cos(n*omega_0*t),t,0,T/2)+int(-A*cos(n*omega_0*t),t,T/2,T))
%%
bi = (2/T)*(int(A*sin(n*omega_0*t),t,0,T/2)+int(-A*sin(n*omega_0*t),t,T/2,T))
...
%
t = [0,0,0,1/2,1/2,1/2,1/2,1,1,1,3/2,3/2,3/2,2,2,2]*T;
