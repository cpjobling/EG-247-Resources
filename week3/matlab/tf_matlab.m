...
% $s = 0,\,−2,\,−4$ and the zeros are $s = −1,\,−3$. 
%
...
% with input “Voltage” and output “Angular Position”. We can add this information 
% to the LTI system as follows:
...
%
% $$y(t) = \right(0.3333 + 0.2381e^{−3t} − 0.5714e^{−10t}\left)u_0(t).$$
%
